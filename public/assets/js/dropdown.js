...
class CustomDropdown {
    ...
    init() {
        ...
        this.button.innerHTML = this.getSelectedText() + '<i data-lucide="chevron-down" class="custom-dropdown-icon"></i>';
    ...
    updateMenu() {
        ...
        options.forEach((option, index) => {
            ...
            item.addEventListener('mouseenter', () => {
                this.menu.querySelectorAll('.custom-dropdown-item').forEach(i => i.classList.remove('hover'));
...
document.addEventListener('DOMContentLoaded', () => {
    const selects = document.querySelectorAll('select.custom-select, select[data-custom="true"]');
