...
try {
    ...
    $pdo->exec("DROP TABLE IF EXISTS articles, categories, sections, comments, users");
...
$stmt = $pdo->prepare("INSERT INTO sections (id, title_bn, title_en, type, highlight_color, associated_category, sort_order) VALUES (?, ?, ?, ?, ?, ?, ?)");
